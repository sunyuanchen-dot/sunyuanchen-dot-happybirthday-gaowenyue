...
explode.prototype = {
    ...
    _explode: function () {
        let embellishmentNum = getRandom(100, 500); // 增加粒子数量
        ...
        for (let i = 0; i < embellishmentNum; i++) {
            ...
            let radius = getRandom(0.5, 1.5); // 减小粒子大小
    ...
    _shapeExplode: function () {
        let that = this;
        putValue(currentFireworks, currentObject, this.shape, 3, function (dots) { // 减小粒子间隔
